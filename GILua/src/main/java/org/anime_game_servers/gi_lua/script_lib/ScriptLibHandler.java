...
public interface ScriptLibHandler<GroupEventContext extends GroupEventLuaContext> {
    ...
    int clearExhibitionReplaceableData(GroupEventContext context, int uid, String key);
    ...
    int getExhibitionAccumulableData(GroupEventContext context, int uid, int exhibitionId);
    int getExhibitionReplaceableData(GroupEventContext context, int uid, int exhibitionId);
