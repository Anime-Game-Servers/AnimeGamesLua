...
public enum GalleryProgressScoreUIType {
    ...
    GALLERY_PROGRESS_SCORE_UI_TYPE_BLADE_DANCE,
    GALLERY_PROGRESS_SCORE_UI_TYPE_REMUS_ARENA,
    GALLERY_PROGRESS_SCORE_UI_TYPE_GENERAL,
    GALLERY_PROGRESS_SCORE_UI_TYPE_FEVER_BATTLE
}
